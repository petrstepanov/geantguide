...
*************************************************************************
      ...
      DATA VERTEX/3*0./  
      DATA PLAB  /3*0./	
      real h1vert, lb1vert, lh1vert, x1
c
...
c
      ...
      data thmax /27.4/
      save h1vert, lb1vert, lh1vert
      data h1vert, lb1vert, lh1vert /2.875,2.70,2.875/
c      data h1vert, lb1vert, lh1vert /2.875,2.875,2.875/
...
c
         ...
         PKINE(4)=2*lh1vert*dummy(5)-h1vert
