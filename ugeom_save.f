...
c     ,2.0,2.0,0./
	DATA LGVOL/25.,0.,0.,2.875,2.875,2.875,0.00,2.875,
     ,2.875,2.875,0./
c
c       unsymmetric legs to light guide
c
        real LGVOL2(11) 
	DATA LGVOL2/25.,0.,0.,2.875,2.70,2.875,0.,2.875,
     ,2.70,2.875,0./
...
c        LGVOL(1)=5-TAPSQ(1)
c
c       compute angles for lgvol2
c
      lgvol2(7) = 180.*atan2(lgvol2(4)-lgvol2(5),2*lgvol2(6))/3.14159
      lgvol2(11) = 180.*atan2(lgvol2(8)-lgvol2(9),2*lgvol2(10))/3.14159
c      print *, ' angle=', lgvol2(7),lgvol2(11)
c
      CALL GIDROP
*************************************************************************
...
c rotate each module depending on position
     ...
     &  (10-TAPSQ(1)),3,'ONLY')
        CALL GSPOS('LTG2',1,'SPAC',(lgvol2(5)-lgvol2(4))/2,0.,
     &   (10-2*TAPSQ(1)-LGVOL2(1)),0,'ONLY')
       CALL GSPOS('TPSQ',1,'SPAC',0.,tapsq(1)/2,(10-TAPSQ(1)),0,'ONLY')
       CALL GSPOS('TPMR',1,'SPAC',0.,-tapsq(1)/2,(10-TAPSQ(1)),2,'ONLY')
       CALL GSPOS('LTGD',1,'SPAC',0.,lgvol(1)+tapsq(1),
     &  (10-TAPSQ(1)),3,'MANY')
